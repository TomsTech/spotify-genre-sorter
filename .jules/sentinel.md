...
## 2026-07-16 - [Hardcoded GitHub OAuth Secret Default / Missing Fallback] **Vulnerability:** [isUserAllowed function lacked proper checking of username argument truthiness leading to bypass with empty string] **Learning:** [Empty string split creates an array containing an empty string which then successfully allowed the empty string username] **Prevention:** [Always aggressively trim, enforce non-empty parameter checks, and filter array items properly after splitting user strings]
