...
## 2025-06-11 - Optimize Bulk Playlist Creation
**Learning:** Sequential execution in a loop of operations like API calls can cause significant performance degradation.
**Action:** Use Promise.all to map array elements to asynchronous operations. Ensure robust failure handling per-element if one operation shouldn't fail the whole array.
