...
## 2026-06-11 - [Non-blocking KV Flush]
**Learning:** Awaiting KV flush operations synchronously in middleware delays the HTTP response to the client.
**Action:** Use `c.executionCtx.waitUntil()` to execute the KV flush in the background without blocking the response.
