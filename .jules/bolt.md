...
## 2024-05-15 - Array.from over for...of push
**Learning:** Re-assigning an array using Array.from on Map.entries() is cleaner and faster than pushing in a for...of loop because it avoids intermediate array allocations and handles sizing internally better.
**Action:** Replaced a for...of push loop on a Map with Array.from in src/routes/api.ts.
