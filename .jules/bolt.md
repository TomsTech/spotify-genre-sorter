...
## 2024-07-10 - [Parallelizing Spotify API Requests for Playlists]
**Learning:** Fetching paginated Spotify API data for playlists and playlist tracks with sequential `while` loops causes N+1 network latency issues, significantly slowing down playlist processing.
