    ...
    function renderGenres() {
      ...
      app.innerHTML = \`
        ...
        <div class="hidden-toolbar" id="hidden-toolbar" style="display: \${hiddenGenres.size > 0 ? 'flex' : 'none'}">
          ...
          <button onclick="toggleShowHidden()" class="btn btn-ghost btn-sm" aria-label="\${showHiddenGenres ? (swedishMode ? 'Dölj dolda genrer' : 'Hide hidden genres') : (swedishMode ? 'Visa dolda genrer' : 'Show hidden genres')}">
