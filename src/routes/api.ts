...
api.get('/admin/invites', async (c) => {
  ...
  try {
    ...
    const requests = requestsRaw ? (JSON.parse(requestsRaw) as unknown[]) : [];
...
api.get('/admin/errors', async (c) => {
  ...
  try {
    ...
    const errors = errorsRaw ? (JSON.parse(errorsRaw) as unknown[]) : [];
...
api.get('/admin/perf', async (c) => {
  ...
  try {
    ...
    const samples = perfRaw ? (JSON.parse(perfRaw) as unknown[]) : [];
